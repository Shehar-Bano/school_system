                  ...
                  <form action="{{ route('transaction.store') }}" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control {{ $errors->has('student_id') ? 'is-invalid' : '' }}" id="employee_id" name="student_id">
                        ...
                        @foreach ($students as $student)
                          <option value="{{ $student->id }}" data-class-id="{{ $student->class_id }}" data-section-id="{{ $student->section_id }}" {{ $transaction->student_id == $student->id ? 'selected' : '' }}>
                            {{ $student->name }}
                          </option>
                        @endforeach
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control {{ $errors->has('student_id') ? 'is-invalid' : '' }}" id="transaction_id" name="transaction_id">
                        ...
                        @foreach ($types as $type)
                          <option value="{{ $type->id }}"  {{$transaction->transaction_id == $type->id ? 'selected' : '' }}>
                            {{ $type->name }}
                          </option>
                        @endforeach
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control {{ $errors->has('transaction_type') ? 'is-invalid' : '' }}" id="transaction_type" name="transaction_type">
                        <option value="" disabled selected></option>
                       <option value="fine" {{ $transaction->transaction_type== 'fine' ? 'selected' : '' }}>Fine</option>
                        <option value="scholarship" {{ $transaction->transaction_type == 'scholarship' ? 'selected' : '' }}>Scholarship</option>
                        <option value="grant" {{ $transaction->transaction_type == 'grant' ? 'selected' : '' }}>Grant</option>
                        <option value="fund" {{ $transaction->transaction_type == 'fund' ? 'selected' : '' }}>Fund</option>
                       </select>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="amount" id="amount" class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}"  value="{{ $transaction->amount}}">
                      @error('amount')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="description" id="description" class="form-control  {{ $errors->has('description') ? 'is-invalid' : '' }} " value="{{ $transaction->description}}">
                      @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control {{ $errors->has('transaction_date') ? 'is-invalid' : '' }}" id="date" name="transaction_date" value="{{ $transaction->transaction_date}}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control {{ $errors->has('due_date') ? 'is-invalid' : '' }}" id="due_date" name="due_date" value="{{ $transaction->due_date}}">
                      @error('due_date')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>

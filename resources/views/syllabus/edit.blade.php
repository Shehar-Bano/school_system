            ...
            <div class="card">
              <div class="card-body">
                <div class="header">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page" style="color: rgb(180, 176, 176)">Update Syllabus</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="form-container">
                  ...
                  <form action="{{ route('syllabus_update',['id'=>$syllabus->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                
                    <div class="form-group">
                        <label for="title">Title</label>
                        <input type="text" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" id="title" name="title" value="{{ $syllabus->title }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" id="description" name="description" value="{{  $syllabus->description }}">
                    ...
                    <div class="form-group">
                        ...
                        @if($syllabus->file)
                            <div class="mt-3">
                                <a href="{{ asset('storage/' . $syllabus->file) }}" target="_blank" class="btn btn-secondary">

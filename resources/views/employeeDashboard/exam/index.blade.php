...
<body>
        ...
        <div class="content-wrapper">
          <div class="container">
            <!-- Add New Exam Button -->
            <div class="mb-4">
              <a href="{{ route('employee.exam.list') }}" class="btn btn-primary">Add New Exam</a>
            </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                       ...
                       @endif
                        ...
                        <td>
                          <!-- Edit Button -->
                          <a href="{{ route('employee.exam.edit', ['id' => $exam->id]) }}" class="btn btn-warning btn-sm" title="Edit">
                            <i class="fas fa-edit"></i>
                          </a>
                          <form action="{{ route('employee.exam.delete', ['id' => $exam->id]) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')

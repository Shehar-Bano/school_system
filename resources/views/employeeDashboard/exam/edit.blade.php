...
<style>
    ...
    <div class="container mt-5">
        <div class="form-container">
            <div class="header">
                <h4><i class="fas fa-pencil-alt"></i> Update Exam</h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{route('employee.dashboard')}}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{route('employee.exams')}}">Exam</a></li>
                         <li class="breadcrumb-item active" aria-current="page" style="color: rgb(180, 176, 176)">Update Exam</li>
                    </ol>
                </nav>
            </div>

            <form class="mt-4" action="{{route('employee.exam.update',['id'=>$exams->id])}}" method="POST" >
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="exam_fee" name="exam_fee" value="{{$exams->exam_fee}}" placeholder="Enter exam fee" >
                </div>
                <div class="mb-3">

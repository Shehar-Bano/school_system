                  ...
                  <table class="table table-striped table-bordered" id="examsTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                           <!-- Edit Button -->
                           <a href="{{ route('employee.exam.date-sheet.edit', ['id' => $exam->exam_schedule_id ]) }}" class="btn btn-warning btn-sm" title="Edit">
                            <i class="fas fa-edit"></i>
                          </a>
                          <form action="{{ route('employee.exam.date-sheet.delete', ['id' => $exam->id]) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')

                ...
                <div class="header">
                  ...
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                      ...
                      <li class="breadcrumb-item active" aria-current="page" style="color: rgb(180, 176, 176)">Add Transactions</li>
                    </ol>
                  </nav>
                </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('transaction_type') ? 'is-invalid' : '' }}" id="transaction_type" name="transaction_type">
                          <option value="" disabled selected></option>
                          <option value="Late Penalty" {{ old('transaction_type') == 'Late Penalty' ? 'selected' : '' }}>Late Penalty</option>
                          <option value="Absentance Penalty" {{ old('transaction_type') == 'Absentance Penalty' ? 'selected' : '' }}>Absentance Penalty</option>
                          <option value="Loan Repayment" {{ old('transaction_type') == 'Loan Repayment' ? 'selected' : '' }}>Loan Repayment</option>
                          <option value="Performance Bonus" {{ old('transaction_type') == 'Performance Bonus' ? 'selected' : '' }}>Performance Bonus</option>
                          <option value="Festival Bonus" {{ old('transaction_type') == 'Festival Bonus' ? 'selected' : '' }}>Festival Bonus</option>
                          <option value="Duty Reward" {{ old('transaction_type') == 'Duty Reward' ? 'selected' : '' }}>Exam Duty Reward</option>
                          <option value="Paper Checking Reward" {{ old('transaction_type') == 'Paper Checking Reward' ? 'selected' : '' }}>Paper Checking Reward</option>
                        </select>

...
Route::group(['prefix' => 'payment/student'], function () {
    Route::group(['prefix' => 'transaction/types'], function () {
        ...
        Route::get('edit/{id}', [TransactionTypeController::class, 'edit'])->name('transaction.type.edit');
        Route::post('update/{id}', [TransactionTypeController::class, 'update'])->name('transaction.type.update');
